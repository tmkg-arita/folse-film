<x-app-layout>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-8">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">編集・更新</h1>
            ...
            <x-auth-validation-errors class="mb-4" :errors="$errors" />
                <div class="flex flex-wrap -m-2">
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            現在の画像
                            <img class="h-40 rounded w-full object-cover object-center mb-6" src="{{ asset('storage/images/'.$userData->user_image) }}" alt="content">
                        </div>
                    </div>
                     <div class="p-2 w-full">
                        <div class="relative">
                            <label for="user_image" class="leading-7 text-sm text-gray-600">画像
                    ...
                    <div class="p-2 w-1/2">
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" required  value="{{ old('movie_time',$userData->email) }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                    </div>
                    <div class="p-2 w-full">
                        <div class="relative">
                            <label for="information" class="leading-7 text-sm text-gray-600">紹介文
                            <textarea id="information" name="information" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ old('information',$userData->information) }}</textarea>
                        </div>
                    </div>


                    <div class="mt-16 flex justify-around p-2 w-full">
                            <button type="button" onclick="location.href='{{route('user.dashboard')}}'" class="text-white bg-pink-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">戻る</button>
