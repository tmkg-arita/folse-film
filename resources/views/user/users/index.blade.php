...
<h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">ユーザー情報</h1>
  ...
  <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
    アイコン<img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="{{! is_null($userData->user_image) ? asset('storage/images/'.$userData->user_image) : asset('/image/no_user.jpg')}}">
    <div class="text-center lg:w-2/3 w-full">
    

      <p class="mb-8 leading-relaxed">名前：{{$userData->name}}</p>
      <p class="mb-8 leading-relaxed">自己紹介：{{! is_null($userData->information) ? $userData->information : '' }}</p>
